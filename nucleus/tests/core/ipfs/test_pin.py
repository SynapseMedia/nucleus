import pytest
import nucleus.core.ipfs.pin as pin

from nucleus.core.ipfs.types import LocalPin, Pin
...
def test_pin_local(mocker: Any):
    ...
    mocker.patch("nucleus.core.ipfs.pin.IPFS", return_value=MockCLI())
...
def test_invalid_pin_remote(mocker: Any):
    ...
    mocker.patch("nucleus.core.ipfs.pin.IPFS",

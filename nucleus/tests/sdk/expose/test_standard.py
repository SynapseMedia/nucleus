...
def test_standard():
    """Should return standard struct with defined data"""
    
    standard = expose.standard("video/H264")
    standard.add_metadata(Structural(cid="bafkreiafogsmhi4yvuk7z4suhcr3rcnztqmt7rydgj3dmk6jeylmglnq5u"))
    standard.add_metadata(Descriptive(title="Hello world", desc="Test"))
    standard.add_metadata(Technical(size=10))
    ...
    payload = Payload(
        ...
        t=CID("QmVrrF7DTnbqKvWR7P7ihJKp4N5fKmBX29m5CHbW9WLep9"),
    )

...
def nft_erc1155_metadata(mv: MovieScheme):
    ...
    del nft_movie['properties']['properties']['resource']  # We dont want to share this XD
    del nft_movie['properties']['properties']['group_name']  # We dont want to share this too XD
    del nft_movie['properties']['properties']['date_uploaded_unix']  # We dont want to share this too XD

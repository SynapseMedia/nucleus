...
class _Stream(Adapter[FFMPEG]):
    ...
    def probe(self, path: Path, **kwargs: Any):
    ...
    def __getattr__(self, name: str):
        ...
        if hasattr(ffmpeg, name):
            ...
            # ref: https://kkroening.github.io/ffmpeg-python/
            if "stream" in args.args or name in ["filter"]:
